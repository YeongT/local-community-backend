...
import updateUserlist from "../group/updateUserlist";
...
router.put ("/", async (req,res) => {
    ...
    //#GENERATE MEMBER OBJECT AND PUBLISH NEW PREVILEGE
    const { userlist, listerror } = await updateUserlist(createCommunity._id ,[], jwtuser._id, ["owner","admin","member"]);
    ...
    if (!_result) return await SAVE_LOG(await responseFunction(res, 500, "ERR_COMMUNITY_UPDATE_FAILED", null, _result), createCommunity);
